...
public class LogicBaseVisitor<T> extends AbstractParseTreeVisitor<T> implements LogicVisitor<T> {
	 ...
	 */
	@Override public T visitStart(LogicParser.StartContext ctx) { return visitChildren(ctx); }
	/**
	 * {@inheritDoc}
	 *
	 * <p>The default implementation returns the result of calling
	 * {@link #visitChildren} on {@code ctx}.</p>
	 */
	@Override public T visitExpr(LogicParser.ExprContext ctx) { return visitChildren(ctx); }
}